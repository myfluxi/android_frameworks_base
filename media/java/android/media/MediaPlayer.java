...
public class MediaPlayer
{
    ...
    */
     ...
     * charset list
     */
    public static final String CHARSET_UNKNOWN                   = "UNKNOWN";                       //�޷�ʶ��������ַ���
    ...
    public static final String CHARSET_ISO_8859_1                = "ISO-8859-1";                    //��ŷ��ϵ
    public static final String CHARSET_ISO_8859_10               = "ISO-8859-10";                   //��ŷ˹������ά����ϵ
    public static final String CHARSET_ISO_8859_13               = "ISO-8859-13";                   //���޵ĺ���ϵ                  
    public static final String CHARSET_ISO_8859_14               = "ISO-8859-14";                   //����������ϵ                  
    public static final String CHARSET_ISO_8859_15               = "ISO-8859-15";                   //�չ�˷����ͷ��������ŷ��ϵ  
    public static final String CHARSET_ISO_8859_16               = "ISO-8859-16";                   //�չ�Ķ���ŷ��ϵ   
    public static final String CHARSET_ISO_8859_2                = "ISO-8859-2";                    //��ŷ����          
    public static final String CHARSET_ISO_8859_3                = "ISO-8859-3";                    //��ŷ����          
    public static final String CHARSET_ISO_8859_4                = "ISO-8859-4";                    //��ŷ����          
    public static final String CHARSET_ISO_8859_5                = "ISO-8859-5";                    //��������ĸ        
    public static final String CHARSET_ISO_8859_6                = "ISO-8859-6";                    //�������          
    public static final String CHARSET_ISO_8859_7                = "ISO-8859-7";                    //ϣ���            
    public static final String CHARSET_ISO_8859_8                = "ISO-8859-8";                    //ϣ�����
    ...
    public static final String CHARSET_TIS_620                   = "TIS-620";                       //̩��
    ...
    public static final String CHARSET_WINDOWS_1250              = "windows-1250";                  //��ŷ                 
    public static final String CHARSET_WINDOWS_1251              = "windows-1251";                  //��������             
    public static final String CHARSET_WINDOWS_1252              = "windows-1252";                  //�������
    public static final String CHARSET_WINDOWS_1253              = "windows-1253";                  //ϣ���     
    public static final String CHARSET_WINDOWS_1254              = "windows-1254";                  //��ŷ��ϵ
    public static final String CHARSET_WINDOWS_1255              = "windows-1255";                  //ϣ�����             
    public static final String CHARSET_WINDOWS_1256              = "windows-1256";                  //�������   
    public static final String CHARSET_WINDOWS_1257              = "windows-1257";                  //���޵ĺ��� 
    public static final String CHARSET_WINDOWS_1258              = "windows-1258";                  //Խ��       
	...
	public static final int PICTURE_3D_MODE_DOUBLE_STREAM			= 1;		//* ��ͼ��ʽ
	public static final int PICTURE_3D_MODE_SIDE_BY_SIDE			= 2;		//* ���Ҹ�ʽ
	public static final int PICTURE_3D_MODE_TOP_TO_BOTTOM			= 3;		//* ���¸�ʽ
	public static final int PICTURE_3D_MODE_LINE_INTERLEAVE			= 4;		//* �н�֯��ʽ
	public static final int PICTURE_3D_MODE_COLUME_INTERLEAVE		= 5;		//* �н�֯��ʽ
     ...
     * defined by ChenXiaoChuan.
     */
	public static final int DISPLAY_3D_MODE_2D				= 0;	//* ��ʾ2Dͼ�񣬶��ڷ�ͼ��ʽ��ֻ��ʾһ��ͼ���������»����Ҹ�ʽ����ʾ���ͼ
	public static final int DISPLAY_3D_MODE_3D				= 1;	//* ��ʾ3Dͼ��
	public static final int DISPLAY_3D_MODE_HALF_PICTURE	= 2;	//* ��ʾ��ͼ���������һ����¸�ʽ��ͼ������
	public static final int DISPLAY_3D_MODE_ANAGLAGH		= 3;	//* ��ʾ��ɫͼ�񣬿��Խ����һ������¸�ʽ��ͼ��ת���ɷ�ɫͼ����ʾ
